...
export const NOSE_TECHNIQUES = {
  straight_slim: { name: "Straight & Slim Refinement", prompt_suffix: "flawless narrow straight nasal bridge, delicate supratip break, refined defined nasal tip cartilage, subtle alar narrowing, seamless skin texture, photorealistic, 8k resolution", strength: 0.45, pinchRadiusRatio: 0.32, pinchAmount: 0.28 },
  dorsal_hump: { name: "Dorsal Hump Reduction", prompt_suffix: "perfectly straight smooth nasal profile, complete dorsal hump reduction, refined bridge, photorealistic", strength: 0.42, pinchRadiusRatio: 0.25, pinchAmount: 0.20 },
  tip_plasty: { name: "Nasal Tip Refinement", prompt_suffix: "delicate narrow tip cartilage, elevated nasal tip angle, subtle supratip break, photorealistic", strength: 0.40, pinchRadiusRatio: 0.22, pinchAmount: 0.22 },
  alar_reduction: { name: "Alar Base Narrowing", prompt_suffix: "narrowed alar base, reduced nostril flare, tight delicate nasal base, photorealistic", strength: 0.38, pinchRadiusRatio: 0.20, pinchAmount: 0.20 },
  liquid_rhino: { name: "Liquid Non-Surgical Rhinoplasty", prompt_suffix: "non-surgical dermal filler alignment, disguised nasal bump, straight bridge profile, photorealistic", strength: 0.35, pinchRadiusRatio: 0.18, pinchAmount: 0.12 },
};
...
export const CHEEK_DOSAGE_MAP: Record<string, { strength: number; dilationPx: number; promptLabel: string }> = {
  "0.50ml": { strength: 0.30, dilationPx: 8, promptLabel: "subtle 0.5ml filler highlight over zygomatic prominence" },
  "1.00ml": { strength: 0.38, dilationPx: 14, promptLabel: "moderate 1.0ml dermal filler augmentation centered on zygomatic process and arch" },
  "1.50ml": { strength: 0.45, dilationPx: 20, promptLabel: "pronounced 1.5ml volumetric cheek projection across entire zygomatic structure" },
};
export const CHIN_TECHNIQUES = {
  anterior_projection: { name: "Anterior Projection (Mentoplasty)", prompt_suffix: "strong forward chin projection, prominent pogonion, well-defined chin tip, balanced facial profile line, photorealistic", strength: 0.48, blurPx: 12 },
  chin_lengthening: { name: "Vertical Chin Elongation", prompt_suffix: "elongated lower facial third, vertically extended chin length, defined lower mentum border, sleek proportion, photorealistic", strength: 0.45, blurPx: 12 },
  v_shape_slimming: { name: "V-Line Slimming / T-Osteotomy", prompt_suffix: "slim V-line chin tip, narrowed mental apex, delicate tapered lower jawline, sleek chin contour, photorealistic", strength: 0.48, blurPx: 12 },
  square_jaw_chin: { name: "Broad Square Chin", prompt_suffix: "broad masculine square chin, strong angular mental width, wide chiseled chin border, photorealistic", strength: 0.48, blurPx: 12 },
  cleft_smoothing: { name: "Chin Dimple / Cleft Smoothing", prompt_suffix: "smooth polished chin skin, completely filled chin dimple cleft, relaxed mentalis muscle, seamless chin contour, photorealistic", strength: 0.42, blurPx: 10 },
};
...
export const DOSAGE_MAP: Record<string, { strength: number; dilationPx: number }> = {
  "0.25ml": { strength: 0.32, dilationPx: 4 },
  "0.50ml": { strength: 0.40, dilationPx: 8 },
  "0.75ml": { strength: 0.48, dilationPx: 12 },
  "1.00ml": { strength: 0.55, dilationPx: 16 },
  "tint_soft": { strength: 0.42, dilationPx: 8 },
  "tint_medium": { strength: 0.50, dilationPx: 14 },
  "tint_bold": { strength: 0.60, dilationPx: 20 },
};
