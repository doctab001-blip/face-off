...
export default function VisualizerApp() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-6 space-y-6 text-white bg-gray-950 min-h-screen select-none touch-pan-y">
      ...
      <header className="border-b border-gray-800 pb-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <Show when="signed-out">
            <div className="flex items-center gap-2">
              <SignInButton mode="modal">
                <button className="text-xs bg-gray-800 hover:bg-gray-700 text-white px-3 py-1.5 rounded border border-gray-700 font-medium">
                  Facility Sign In
                </button>
              </SignInButton>
